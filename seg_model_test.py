...
class BiLSTMTest(object):
    def __init__(self, data=None, model_path='ckpt/seg',
                 test_file='test/test.txt', test_result='test/seg_result.txt'):
        self.data = data
...
if __name__ == '__main__':
    ...
    data = readData.DataHandler(save_path = 'data/SEG_training_data.pkl')
    data.loadData()
    print('加载字典(分词)完成')
