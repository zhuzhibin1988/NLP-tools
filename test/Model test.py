...
segmenter = BiLSTMSegmenter(data_path='E:/02program/python/nlp/NLP-tools/data/', model_path='E:/02program/python/nlp/NLP-tools/checkpoint/')

# ###### 模型预测


# 示例1
print('示例1：', segmenter.predict('2003年10月15日，杨利伟乘由长征二号F火箭运载的神舟五号飞船首次进入太空，象征着中国太空事业向前迈进一大步，起到了里程碑的作用。'))
