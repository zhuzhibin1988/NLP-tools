...
tf.app.flags.DEFINE_string('dict_path', os.path.join(root_dir, "data", "your_dict.pkl"), 'dict path')
tf.app.flags.DEFINE_string('train_data', os.path.join(root_dir, "data", "your_train_data.pkl"), 'train data path')
